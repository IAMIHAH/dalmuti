...
GuideEmbed = [
	...
	disnake.Embed(
		title="📖 이용 가이드",
		description="게임 채널을 생성하려면 `/달무티`를 실행해 로비창을 띄워야 해요.\n\n공개 채널은 **봇 DM**에서 생성할 수 있어요.\n아직 공개 채널은 만들어지지 않아서 비공개 채널로만 이용해야 해요.\n\n비공개 채널은 **채널 입장을 원하는 서버**에서 생성할 수 있어요."
	).set_image(url="https://bpmo.xyz/box/dalmuti-guide/create-channel.png"),
	disnake.Embed(
		title="📖 이용 가이드",
	...
	).set_image(url="https://bpmo.xyz/box/dalmuti-guide/join-channel.png"),
	disnake.Embed(
		title="🎮 게임 가이드",
	...
	).set_image(url="https://bpmo.xyz/box/dalmuti-guide/order.png"),
	disnake.Embed(
		title="🎮 게임 가이드",
	...
	).set_image(url="https://bpmo.xyz/box/dalmuti-guide/jogong.png"),
	disnake.Embed(
		title="🎮 게임 가이드",
